...
use Minetro\Normgen\Generator\Model\ModelGenerator;
...
final class SimpleFactory
{
	...
	public function create()
	{
		...
		$normgen->setEntityGenerator(new EntityGenerator($this->config, $resolver, $resolver, $resolver));
		$normgen->setRepositoryGenerator(new RepositoryGenerator($this->config, $resolver, $resolver, $resolver, $resolver));
		$normgen->setMapperGenerator(new MapperGenerator($this->config, $resolver, $resolver, $resolver));
